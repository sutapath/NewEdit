        ...
        <form @submit.prevent="handleSubmit" enctype="multipart/form-data">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-6 w-full mt-3">
            ...
            <div class="mb-4">
              ...
              />
              <div v-if="form.errors.file" class="text-red-500 text-sm mt-1">{{  'กรุณาเพิ่มหลักฐานการเข้าร่วมกิจกรรม' }}</div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-6 w-full">
            ...
            <div class="mb-4">
              ...
              <div v-if="form.errors.hours" class="text-red-500 text-sm mt-1">{{ 'กรุณาเพิ่มชั่วโมง' }}</div>
